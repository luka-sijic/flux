...
function Requests() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Requests.useEffect": ()=>{
            const fetchUsername = {
                "Requests.useEffect.fetchUsername": async ()=>{
                    try {
            ...
            }["Requests.useEffect.fetchUsername"];
            fetchUsername();
        }
    }["Requests.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Requests.useEffect": ()=>{
            const fetchFriendReq = {
                "Requests.useEffect.fetchFriendReq": async ()=>{
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("http://127.0.0.1:8081/friend");
                    console.log(response);
                    if (response.status === 200) {
                        setFriends(response.data);
                    }
                }
            }["Requests.useEffect.fetchFriendReq"];
            fetchFriendReq();
        }
    }["Requests.useEffect"], []);
    const friendResponse = async (e)=>{
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://127.0.0.1:8081/friend/respond", data, {
            headers: {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                        ...
                        children: [
                            ...
                            friends.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                lineNumber: 95,
                                columnNumber: 13
                            }, this) : friends.map((f, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
_s(Requests, "d013AENLOqDEp4iIEPbCWJwc+XY=", false, function() {
    return [
